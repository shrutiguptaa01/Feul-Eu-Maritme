...
async function seed() {
    ...
    for (const r of routes) {
        await client_1.db.query(`INSERT INTO routes(route_id, vessel_type, fuel_type, year, ghg_intensity, fuel_tons, distance_km, total_emissions_t, is_baseline)
       VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9)
       ON CONFLICT (route_id) DO NOTHING`, r);
    }
